...
public class CounterServiceVertxEBProxy implements CounterService {
  private Vertx _vertx;
  private String _address;
  private DeliveryOptions _options;
  private boolean closed;

  public CounterServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public CounterServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public  void addThenRetrieveBy(String key, Long increment, Handler<AsyncResult<Long>> resultHandler){
    ...
    JsonObject _json = new JsonObject();
    _json.put("key", key);
    _json.put("increment", increment);

    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "addThenRetrieveBy");
    _vertx.eventBus().<Long>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        resultHandler.handle(Future.failedFuture(res.cause()));
      } else {
  ...
  public  void reset(String key, Handler<AsyncResult<Void>> resultHandler){
    ...
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "reset");
