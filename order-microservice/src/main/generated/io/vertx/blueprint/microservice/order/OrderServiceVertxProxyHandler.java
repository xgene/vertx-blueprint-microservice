    ...
    try{
      ...
      switch (action) {
        ...
        case "retrieveOrdersForAccount": {
          service.retrieveOrdersForAccount((java.lang.String)json.getValue("accountId"),
                        res -> {
                        if (res.failed()) {
        ...
        case "createOrder": {
          service.createOrder(json.getJsonObject("order") == null ? null : new io.vertx.blueprint.microservice.order.Order(json.getJsonObject("order")),
                        HelperUtils.createHandler(msg));
          break;
        }
        case "retrieveOrder": {
          service.retrieveOrder(json.getValue("orderId") == null ? null : (json.getLong("orderId").longValue()),
                        res -> {
                        if (res.failed()) {
                          if (res.cause() instanceof ServiceException) {
                            msg.reply(res.cause());
