...
public class StoreCRUDServiceVertxProxyHandler extends ProxyHandler {
  ...
  public void handle(Message<JsonObject> msg) {
    try{
      ...
      switch (action) {
        case "saveStore": {
          service.saveStore(json.getJsonObject("store") == null ? null : new io.vertx.blueprint.microservice.store.Store(json.getJsonObject("store")),
                        HelperUtils.createHandler(msg));
          break;
        }
        case "retrieveStore": {
          service.retrieveStore((java.lang.String)json.getValue("sellerId"),
                        res -> {
                        if (res.failed()) {
        ...
        case "removeStore": {
          service.removeStore((java.lang.String)json.getValue("sellerId"),
                        HelperUtils.createHandler(msg));
          break;
        }
