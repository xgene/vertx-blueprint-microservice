...
public class ShoppingCartServiceVertxProxyHandler extends ProxyHandler {
  ...
  public void handle(Message<JsonObject> msg) {
    try{
      ...
      switch (action) {
        case "addCartEvent": {
          service.addCartEvent(json.getJsonObject("event") == null ? null : new io.vertx.blueprint.microservice.cart.CartEvent(json.getJsonObject("event")),
                        HelperUtils.createHandler(msg));
          break;
        }
        case "getShoppingCart": {
          service.getShoppingCart((java.lang.String)json.getValue("userId"),
                        res -> {
                        if (res.failed()) {
