    ...
    try{
      ...
      switch (action) {
        ...
        case "addPaymentRecord": {
          service.addPaymentRecord(json.getJsonObject("payment") == null ? null : new io.vertx.blueprint.microservice.payment.Payment(json.getJsonObject("payment")),
                        HelperUtils.createHandler(msg));
          break;
        }
        case "retrievePaymentRecord": {
          service.retrievePaymentRecord((java.lang.String)json.getValue("payId"),
                        res -> {
                        if (res.failed()) {
