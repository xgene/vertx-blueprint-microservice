...
/// <reference path="./counter_service-proxy.d.ts" />
  ...
  var CounterService = function(eb, address) {
    ...
    this.addThenRetrieve =  function(key, resultHandler) {
      ...
      if (__args.length === 2 && typeof __args[0] === 'string' && typeof __args[1] === 'function') {
        ...
        j_eb.send(j_address, {"key":__args[0]}, {"action":"addThenRetrieve"}, function(err, result) { __args[1](err, result && result.body); });
        return;
    ...
    this.addThenRetrieveBy =  function(key, increment, resultHandler) {
      ...
      if (__args.length === 3 && typeof __args[0] === 'string' && typeof __args[1] ==='number' && typeof __args[2] === 'function') {
        ...
        j_eb.send(j_address, {"key":__args[0], "increment":__args[1]}, {"action":"addThenRetrieveBy"}, function(err, result) { __args[2](err, result && result.body); });
        return;
      } else throw new TypeError('function invoked with invalid arguments');
    };
    ...
    this.retrieveThenAdd =  function(key, resultHandler) {
      ...
      if (__args.length === 2 && typeof __args[0] === 'string' && typeof __args[1] === 'function') {
        ...
        j_eb.send(j_address, {"key":__args[0]}, {"action":"retrieveThenAdd"}, function(err, result) { __args[1](err, result && result.body); });
        return;
      } else throw new TypeError('function invoked with invalid arguments');
    };
    ...
    this.reset =  function(key, resultHandler) {
      ...
      if (__args.length === 2 && typeof __args[0] === 'string' && typeof __args[1] === 'function') {
        ...
        j_eb.send(j_address, {"key":__args[0]}, {"action":"reset"}, function(err, result) { __args[1](err, result && result.body); });
        return;
      } else throw new TypeError('function invoked with invalid arguments');
    };
